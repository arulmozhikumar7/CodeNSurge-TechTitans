...
const Weather = () => {
  ...
  return (
    <div
      className={`flex flex-col md:flex-row justify-between items-center p-6 rounded-xl shadow-2xl ${getWeatherBackground()} transform hover:scale-105 transition duration-500 ease-in-out w-full max-w-2xl mx-auto my-8`}>
