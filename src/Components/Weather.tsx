...
const Weather = () => { 
  ...
  return (
    <div className="flex container  mx-auto border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden hover:scale-105 transition duration-500 w-1/3 m-3   ">
